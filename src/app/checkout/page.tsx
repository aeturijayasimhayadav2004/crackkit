...
import { Zap, CreditCard, Lock, ArrowLeft, Building2, Smartphone } from "lucide-react";
...
export default function CheckoutPage() {
  ...
  const handleMockPayment = () => {
    toast.loading("Processing payment via Razorpay...", { duration: 2000 });
    setTimeout(() => {
      toast.dismiss();
  ...
  return (
    <PageTransition>
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <Link href="/cart" className="inline-flex items-center gap-2 text-text-secondary hover:text-white transition-colors mb-8 text-sm font-medium">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="bg-surface border border-border rounded-2xl p-6">
              ...
              <div className="space-y-3 pt-6 border-t border-border">
                ...
                <div className="flex justify-between items-end pt-4 mt-2 border-t border-border">
                  ...
                  <span className="text-3xl font-bold font-mono text-primary">{formatPrice(totalPrice)}</span>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2">
             <div className="bg-surface border border-border rounded-2xl p-6 lg:p-10 sticky top-24 shadow-2xl">
                <h2 className="text-2xl font-bold text-white mb-8 text-center font-syne">Complete Your Purchase</h2>
                
                <div className="text-center mb-8">
                  <span className="text-sm text-text-secondary block mb-2">Total Amount</span>
                  <span className="text-5xl font-bold font-mono text-white tracking-tight">{formatPrice(totalPrice)}</span>
                </div>
                ...
                <button 
                  ...
                  className="w-full py-5 rounded-xl bg-primary hover:bg-primary-hover text-white font-bold text-lg transition-all shadow-[0_0_20px_rgba(108,92,231,0.3)] mb-4 flex items-center justify-center gap-2"
                >
                ...
                <div className="flex items-center justify-center gap-2 mb-8">
                   ...
                   <span className="text-xs text-text-secondary font-medium">256-bit SSL Secured by Razorpay</span>
                </div>
